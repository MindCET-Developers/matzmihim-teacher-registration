...
function entityDefinition(env, type) {
  return type === 'school'
    ...
    : { type, tableId: encodeURIComponent('הקצאות להשתלמויות'), nameFields: ['בי״ס מרכז פסג״ה', 'ביס מרכז פסגה', 'השתלמות', 'שם ההשתלמות', 'שם השתלמות'], writeNameField: 'בי״ס מרכז פסג״ה' };
}
